...
SIRML1=function(params,times,data,lamda,initial_value){
  params = abs(params)
  #initial_value[2] = params[5]
  #initial_value[3] = params[6]
  #initial_value[1] = 1 - params[5] - params[6]
...
lamda = 0
c <- 1
mea_vector_SInRsir <- c()
PARAMETERS_SInRsir <- c()
...
while (c < 500) {
  ...
  mea_vector_SInRsir <- c(mea_vector_SInRsir,b$MSE)
  PARAMETERS_SInRsir <- rbind(PARAMETERS_SInRsir,b$parameters)
...
lamda = 0.4
c <- 1
mea_vector_1_SInRsir <- c()
PARAMETERS_1_SInRsir <- c()
...
while (c < 500) {
  ...
  DATA_test <-  DATA[(end+1):n]
  b <- Blocking_CV_1(DATA_train , DATA_test, lamda,initial_value,initial_par)
  mea_vector_1_SInRsir <- c(mea_vector_1_SInRsir,b$MSE)
  PARAMETERS_1_SInRsir <- rbind(PARAMETERS_1_SInRsir,b$parameters)
...
lamda = 0.8
c <- 1
mea_vector_2_SInRsir <- c()
PARAMETERS_2_SInRsir <- c()
while (c < 500) {
  beta_1 <- rnorm(1, mean = 1.4247, sd = 1.4247*0.2)
  gamma_1 <- rnorm(1, mean = 0.14286, sd = 0.14286*0.2)
  beta_2 <- rnorm(1, mean = 0, sd = 1.4247*0.2)
  ...
  DATA_test <-  DATA[(end+1):n]
  b <- Blocking_CV_1(DATA_train , DATA_test, lamda,initial_value,initial_par)
  mea_vector_2_SInRsir <- c(mea_vector_2_SInRsir,b$MSE)
  PARAMETERS_2_SInRsir <- rbind(PARAMETERS_2_SInRsir,b$parameters)
...
lamda = 1.2
c <- 1
mea_vector_3_SInRsir <- c()
PARAMETERS_3_SInRsir <- c()
while (c < 500) {
  beta_1 <- rnorm(1, mean = 1.4247, sd = 1.4247*0.2)
  gamma_1 <- rnorm(1, mean = 0.14286, sd = 0.14286*0.2)
  beta_2 <- rnorm(1, mean = 0, sd = 1.4247*0.2)
  ...
  DATA_test <-  DATA[(end+1):n]
  b <- Blocking_CV_1(DATA_train , DATA_test, lamda,initial_value,initial_par)
  mea_vector_3_SInRsir <- c(mea_vector_3_SInRsir,b$MSE)
  PARAMETERS_3_SInRsir <- rbind(PARAMETERS_3_SInRsir,b$parameters)
...
lamda = 1.6
c <- 1
mea_vector_4_SInRsir <- c()
PARAMETERS_4_SInRsir <- c()
while (c < 500) {
  beta_1 <- rnorm(1, mean = 1.4247, sd = 1.4247*0.2)
  gamma_1 <- rnorm(1, mean = 0.14286, sd = 0.14286*0.2)
  beta_2 <- rnorm(1, mean = 0, sd = 1.4247*0.2)
  ...
  DATA_test <-  DATA[(end+1):n]
  b <- Blocking_CV_1(DATA_train , DATA_test, lamda,initial_value,initial_par)
  mea_vector_4_SInRsir <- c(mea_vector_4_SInRsir,b$MSE)
  PARAMETERS_4_SInRsir <- rbind(PARAMETERS_4_SInRsir,b$parameters)
...
lamda = 2
c <- 1
mea_vector_5_SInRsir <- c()
PARAMETERS_5_SInRsir <- c()
while (c < 500) {
  beta_1 <- rnorm(1, mean = 1.4247, sd = 1.4247*0.2)
  gamma_1 <- rnorm(1, mean = 0.14286, sd = 0.14286*0.2)
  beta_2 <- rnorm(1, mean = 0, sd = 1.4247*0.2)
  ...
  DATA_test <-  DATA[(end+1):n]
  b <- Blocking_CV_1(DATA_train , DATA_test, lamda,initial_value,initial_par)
  mea_vector_5_SInRsir <- c(mea_vector_5_SInRsir,b$MSE)
  PARAMETERS_5_SInRsir <- rbind(PARAMETERS_5_SInRsir,b$parameters)
...
lamda = 0
c <- 1
peak_mea_vector_SInRsir <- c()
peak_PARAMETERS_SInRsir <- c()
while (c < 500) {
  beta_1 <- rnorm(1, mean = 1.4247, sd = 1.4247*0.2)
  gamma_1 <- rnorm(1, mean = 0.14286, sd = 0.14286*0.2)
  beta_2 <- rnorm(1, mean = 0, sd = 1.4247*0.2)
  ...
  DATA_test <-  DATA[(end+1):n]
  b <- Blocking_CV_1(DATA_train , DATA_test, lamda,initial_value,initial_par)
  peak_mea_vector_SInRsir <- c(peak_mea_vector_SInRsir,b$MSE)
  peak_PARAMETERS_SInRsir <- rbind(peak_PARAMETERS_SInRsir,b$parameters)
...
lamda = 0.4
c <- 1
peak_mea_vector_1_SInRsir <- c()
peak_PARAMETERS_1_SInRsir <- c()
while (c < 500) {
  beta_1 <- rnorm(1, mean = 1.4247, sd = 1.4247*0.2)
  gamma_1 <- rnorm(1, mean = 0.14286, sd = 0.14286*0.2)
  beta_2 <- rnorm(1, mean = 0, sd = 1.4247*0.2)
  ...
  DATA_test <-  DATA[(end+1):n]
  b <- Blocking_CV_1(DATA_train , DATA_test, lamda,initial_value,initial_par)
  peak_mea_vector_1_SInRsir <- c(peak_mea_vector_1_SInRsir,b$MSE)
  peak_PARAMETERS_1_SInRsir <- rbind(peak_PARAMETERS_1_SInRsir,b$parameters)
...
lamda = 0.8
c <- 1
peak_mea_vector_2_SInRsir <- c()
peak_PARAMETERS_2_SInRsir <- c()
while (c < 500) {
  beta_1 <- rnorm(1, mean = 1.4247, sd = 1.4247*0.2)
  gamma_1 <- rnorm(1, mean = 0.14286, sd = 0.14286*0.2)
  beta_2 <- rnorm(1, mean = 0, sd = 1.4247*0.2)
  ...
  DATA_test <-  DATA[(end+1):n]
  b <- Blocking_CV_1(DATA_train , DATA_test, lamda,initial_value,initial_par)
  peak_mea_vector_2_SInRsir <- c(peak_mea_vector_2_SInRsir,b$MSE)
  peak_PARAMETERS_2_SInRsir <- rbind(peak_PARAMETERS_2_SInRsir,b$parameters)
...
lamda = 1.2
c <- 1
peak_mea_vector_3_SInRsir <- c()
peak_PARAMETERS_3_SInRsir <- c()
while (c < 500) {
  beta_1 <- rnorm(1, mean = 1.4247, sd = 1.4247*0.2)
  gamma_1 <- rnorm(1, mean = 0.14286, sd = 0.14286*0.2)
  beta_2 <- rnorm(1, mean = 0, sd = 1.4247*0.2)
  ...
  DATA_test <-  DATA[(end+1):n]
  b <- Blocking_CV_1(DATA_train , DATA_test, lamda,initial_value,initial_par)
  peak_mea_vector_3_SInRsir <- c(peak_mea_vector_3_SInRsir,b$MSE)
  peak_PARAMETERS_3_SInRsir <- rbind(peak_PARAMETERS_3_SInRsir,b$parameters)
...
lamda = 1.6
c <- 1
peak_mea_vector_4_SInRsir <- c()
peak_PARAMETERS_4_SInRsir <- c()
while (c < 500) {
  beta_1 <- rnorm(1, mean = 1.4247, sd = 1.4247*0.2)
  gamma_1 <- rnorm(1, mean = 0.14286, sd = 0.14286*0.2)
  beta_2 <- rnorm(1, mean = 0, sd = 1.4247*0.2)
  ...
  DATA_test <-  DATA[(end+1):n]
  b <- Blocking_CV_1(DATA_train , DATA_test, lamda,initial_value,initial_par)
  peak_mea_vector_4_SInRsir <- c(peak_mea_vector_4_SInRsir,b$MSE)
  peak_PARAMETERS_4_SInRsir <- rbind(peak_PARAMETERS_4_SInRsir,b$parameters)
...
lamda = 2
c <- 1
peak_mea_vector_5_SInRsir <- c()
peak_PARAMETERS_5_SInRsir <- c()
while (c < 500) {
  beta_1 <- rnorm(1, mean = 1.4247, sd = 1.4247*0.2)
  gamma_1 <- rnorm(1, mean = 0.14286, sd = 0.14286*0.2)
  beta_2 <- rnorm(1, mean = 0, sd = 1.4247*0.2)
  ...
  DATA_test <-  DATA[(end+1):n]
  b <- Blocking_CV_1(DATA_train , DATA_test, lamda,initial_value,initial_par)
  peak_mea_vector_5_SInRsir <- c(peak_mea_vector_5_SInRsir,b$MSE)
  peak_PARAMETERS_5_SInRsir <- rbind(peak_PARAMETERS_5_SInRsir,b$parameters)
...
initial_value <- c(1-1e-6, (1e-6)/2 , (1e-6)/2, 0 )
initial_par <- c(1.3, 0.12, 0.1, 0.02,  (1e-6)/2 )
lamda <- 0
...
lamda = 0
c <- 1
residule_mea_vector_SInRsir <- c()
residule_PARAMETERS_SInRsir <- c()
while (c < 500) {
  beta_1 <- rnorm(1, mean = 1.4247, sd = 1.4247*0.2)
  gamma_1 <- rnorm(1, mean = 0.14286, sd = 0.14286*0.2)
  beta_2 <- rnorm(1, mean = 0, sd = 1.4247*0.2)
  ...
  b <- Blocking_CV_1(DATA_train , DATA_test, lamda,initial_value,initial_par)
  residule_mea_vector_SInRsir <- c(residule_mea_vector_SInRsir,b$MSE)
  residule_PARAMETERS_SInRsir <- rbind(residule_PARAMETERS_SInRsir,b$parameters)
  c <- c+1
}
c <- 1
while (c < 500) {
...
lamda = 0.4
c <- 1
residule_mea_vector_1_SInRsir <- c()
residule_PARAMETERS_1_SInRsir <- c()
while (c < 500) {
  beta_1 <- rnorm(1, mean = 1.4247, sd = 1.4247*0.2)
  gamma_1 <- rnorm(1, mean = 0.14286, sd = 0.14286*0.2)
  beta_2 <- rnorm(1, mean = 0, sd = 1.4247*0.2)
  ...
  DATA_test <-  abs(DATA+rnorm(length(DATA), mean = mean_residule, sd = sd_residule))  
  b <- Blocking_CV_1(DATA_train , DATA_test, lamda,initial_value,initial_par)
  residule_mea_vector_1_SInRsir <- c(residule_mea_vector_1_SInRsir,b$MSE)
  residule_PARAMETERS_1_SInRsir <- rbind(residule_PARAMETERS_1_SInRsir,b$parameters)
  c <- c+1
}
c <- 1
while (c < 500) {
...
lamda = 0.8
c <- 1
residule_mea_vector_2_SInRsir <- c()
residule_PARAMETERS_2_SInRsir <- c()
while (c < 500) {
  beta_1 <- rnorm(1, mean = 1.4247, sd = 1.4247*0.2)
  gamma_1 <- rnorm(1, mean = 0.14286, sd = 0.14286*0.2)
  beta_2 <- rnorm(1, mean = 0, sd = 1.4247*0.2)
  ...
  DATA_test <-  abs(DATA+rnorm(length(DATA), mean = mean_residule, sd = sd_residule))  
  b <- Blocking_CV_1(DATA_train , DATA_test, lamda,initial_value,initial_par)
  residule_mea_vector_2_SInRsir <- c(residule_mea_vector_2_SInRsir,b$MSE)
  residule_PARAMETERS_2_SInRsir <- rbind(residule_PARAMETERS_2_SInRsir,b$parameters)
  c <- c+1
}
c <- 1
while (c < 500) {
...
lamda = 1.2
c <- 1
residule_mea_vector_3_SInRsir <- c()
residule_PARAMETERS_3_SInRsir <- c()
while (c < 500) {
  beta_1 <- rnorm(1, mean = 1.4247, sd = 1.4247*0.2)
  gamma_1 <- rnorm(1, mean = 0.14286, sd = 0.14286*0.2)
  beta_2 <- rnorm(1, mean = 0, sd = 1.4247*0.2)
  ...
  DATA_test <-  abs(DATA+rnorm(length(DATA), mean = mean_residule, sd = sd_residule))  
  b <- Blocking_CV_1(DATA_train , DATA_test, lamda,initial_value,initial_par)
  residule_mea_vector_3_SInRsir <- c(residule_mea_vector_3_SInRsir,b$MSE)
  residule_PARAMETERS_3_SInRsir <- rbind(residule_PARAMETERS_3_SInRsir,b$parameters)
  c <- c+1
}
c <- 1
while (c < 500) {
...
lamda = 1.6
c <- 1
residule_mea_vector_4_SInRsir <- c()
residule_PARAMETERS_4_SInRsir <- c()
while (c < 500) {
  beta_1 <- rnorm(1, mean = 1.4247, sd = 1.4247*0.2)
  gamma_1 <- rnorm(1, mean = 0.14286, sd = 0.14286*0.2)
  beta_2 <- rnorm(1, mean = 0, sd = 1.4247*0.2)
  ...
  DATA_test <-  abs(DATA+rnorm(length(DATA), mean = mean_residule, sd = sd_residule))  
  b <- Blocking_CV_1(DATA_train , DATA_test, lamda,initial_value,initial_par)
  residule_mea_vector_4_SInRsir <- c(residule_mea_vector_4_SInRsir,b$MSE)
  residule_PARAMETERS_4_SInRsir <- rbind(residule_PARAMETERS_4_SInRsir,b$parameters)
  c <- c+1
}
c <- 1
while (c < 500) {
...
lamda = 2
c <- 1
residule_mea_vector_5_SInRsir <- c()
residule_PARAMETERS_5_SInRsir <- c()
while (c < 500) {
  beta_1 <- rnorm(1, mean = 1.4247, sd = 1.4247*0.2)
  gamma_1 <- rnorm(1, mean = 0.14286, sd = 0.14286*0.2)
  beta_2 <- rnorm(1, mean = 0, sd = 1.4247*0.2)
  ...
  DATA_test <-  abs(DATA+rnorm(length(DATA), mean = mean_residule, sd = sd_residule))  
  b <- Blocking_CV_1(DATA_train , DATA_test, lamda,initial_value,initial_par)
  residule_mea_vector_5_SInRsir <- c(residule_mea_vector_5_SInRsir,b$MSE)
  residule_PARAMETERS_5_SInRsir <- rbind(residule_PARAMETERS_5_SInRsir,b$parameters)
  c <- c+1
}
c <- 1
while (c < 500) {
...
lamda = 0
c <- 1
diff_mea_vector_SInRsir <- c()
diff_PARAMETERS_SInRsir <- c()
while (c < 500) {
  beta_1 <- rnorm(1, mean = 1.4247, sd = 1.4247*0.2)
  gamma_1 <- rnorm(1, mean = 0.14286, sd = 0.14286*0.2)
  beta_2 <- rnorm(1, mean = 0, sd = 1.4247*0.2)
  ...
  b <- Blocking_CV_1(DATA_train , DATA_test, lamda,initial_value,initial_par)
  diff_mea_vector_SInRsir <- c(diff_mea_vector_SInRsir,b$MSE)
  diff_PARAMETERS_SInRsir <- rbind(diff_PARAMETERS_SInRsir,b$parameters)
  c <- c+1
}
c <- 1
while (c < 500) {
...
lamda = 0.4
c <- 1
diff_mea_vector_1_SInRsir <- c()
diff_PARAMETERS_1_SInRsir <- c()
while (c < 500) {
  beta_1 <- rnorm(1, mean = 1.4247, sd = 1.4247*0.2)
  gamma_1 <- rnorm(1, mean = 0.14286, sd = 0.14286*0.2)
  beta_2 <- rnorm(1, mean = 0, sd = 1.4247*0.2)
  ...
  DATA_test <-  abs(DATA_test)  
  b <- Blocking_CV_1(DATA_train , DATA_test, lamda,initial_value,initial_par)
  diff_mea_vector_1_SInRsir <- c(diff_mea_vector_1_SInRsir,b$MSE)
  diff_PARAMETERS_1_SInRsir <- rbind(diff_PARAMETERS_1_SInRsir,b$parameters)
  c <- c+1
}
c <- 1
while (c < 500) {
...
lamda = 0.8
c <- 1
diff_mea_vector_2_SInRsir <- c()
diff_PARAMETERS_2_SInRsir <- c()
while (c < 500) {
  beta_1 <- rnorm(1, mean = 1.4247, sd = 1.4247*0.2)
  gamma_1 <- rnorm(1, mean = 0.14286, sd = 0.14286*0.2)
  beta_2 <- rnorm(1, mean = 0, sd = 1.4247*0.2)
  ...
  DATA_test <-  abs(DATA_test)  
  b <- Blocking_CV_1(DATA_train , DATA_test, lamda,initial_value,initial_par)
  diff_mea_vector_2_SInRsir <- c(diff_mea_vector_2_SInRsir,b$MSE)
  diff_PARAMETERS_2_SInRsir <- rbind(diff_PARAMETERS_2_SInRsir,b$parameters)
  c <- c+1
}
c <- 1
while (c < 500) {
...
lamda = 1.2
c <- 1
diff_mea_vector_3_SInRsir <- c()
diff_PARAMETERS_3_SInRsir <- c()
while (c < 500) {
  beta_1 <- rnorm(1, mean = 1.4247, sd = 1.4247*0.2)
  gamma_1 <- rnorm(1, mean = 0.14286, sd = 0.14286*0.2)
  beta_2 <- rnorm(1, mean = 0, sd = 1.4247*0.2)
  ...
  DATA_test <-  abs(DATA_test)  
  b <- Blocking_CV_1(DATA_train , DATA_test, lamda,initial_value,initial_par)
  diff_mea_vector_3_SInRsir <- c(diff_mea_vector_3_SInRsir,b$MSE)
  diff_PARAMETERS_3_SInRsir <- rbind(diff_PARAMETERS_3_SInRsir,b$parameters)
  c <- c+1
}
c <- 1
while (c < 500) {
...
lamda = 1.6
c <- 1
diff_mea_vector_4_SInRsir <- c()
diff_PARAMETERS_4_SInRsir <- c()
while (c < 500) {
  beta_1 <- rnorm(1, mean = 1.4247, sd = 1.4247*0.2)
  gamma_1 <- rnorm(1, mean = 0.14286, sd = 0.14286*0.2)
  beta_2 <- rnorm(1, mean = 0, sd = 1.4247*0.2)
  ...
  DATA_test <-  abs(DATA_test)  
  b <- Blocking_CV_1(DATA_train , DATA_test, lamda,initial_value,initial_par)
  diff_mea_vector_4_SInRsir <- c(diff_mea_vector_4_SInRsir,b$MSE)
  diff_PARAMETERS_4_SInRsir <- rbind(diff_PARAMETERS_4_SInRsir,b$parameters)
  c <- c+1
}
c <- 1
while (c < 500) {
...
lamda = 2
c <- 1
diff_mea_vector_5_SInRsir <- c()
diff_PARAMETERS_5_SInRsir <- c()
while (c < 500) {
  beta_1 <- rnorm(1, mean = 1.4247, sd = 1.4247*0.2)
  gamma_1 <- rnorm(1, mean = 0.14286, sd = 0.14286*0.2)
  beta_2 <- rnorm(1, mean = 0, sd = 1.4247*0.2)
  ...
  DATA_test <-  abs(DATA_test)  
  b <- Blocking_CV_1(DATA_train , DATA_test, lamda,initial_value,initial_par)
  diff_mea_vector_5_SInRsir <- c(diff_mea_vector_5_SInRsir,b$MSE)
  diff_PARAMETERS_5_SInRsir <- rbind(diff_PARAMETERS_5_SInRsir,b$parameters)
  c <- c+1
}
c <- 1
while (c < 500) {
...
data2 <- data.frame(
  beta1 = PARAMETERS_2_SInRsir[,2],
  beta2 = PARAMETERS_2_SInRsir[,4],
  group = "With LASSO "
)

combined_data <- rbind(data1, data2)

extra_point <- data.frame(x = 0.14286, y = 0)
extra_point1 <- data.frame(x = 0, y = 0.14286)
...
######### MSE plot
vector1 <- mea_vector_SInRsir
vector2 <- mea_vector_1_SInRsir
vector3 <- mea_vector_2_SInRsir
vector4 <- mea_vector_3_SInRsir
vector5 <- mea_vector_4_SInRsir
vector6 <- mea_vector_5_SInRsir
...
for (i in 1:dim(PARAMETERS_2_SInRsir)[1]){
  parameters <- PARAMETERS_2_SInRsir[i,]
...
p <- ggplot(data, aes(x = x)) +
  ...
  labs(color = " ", fill = " ") +
  labs(x = "Time (days)", y = "Infections", title = "SI2R to fit SIR") +
  theme_minimal()
