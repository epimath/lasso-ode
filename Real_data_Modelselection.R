## Title: "Model selection for real data: Asymptomatic model VS. SIR"
## Date: 10-25-2024
## Author: Jiale Tan
...
#####     2. Test model generator: Asymptomatic model + SIR model 
model3_asymp_restrict <- function(t,x,params){
  ...
  list(c(dS_M3, dI_S, dI_A, dR_S, dR_A, dW_M3, dS, dI, dR))
}
...
SIURML1=function(params,times,data,lamda,initial_value){
  ...
  Lasso = sum((y - data)^2)  + lamda*(abs(params[1])+abs(params[2])+abs(params[3])+abs(params[4])+abs(params[5])+abs(params[9])+abs(params[10]))
...
Blocking_CV_1 <- function(Data_train,Data_test,lamda,initial_value,initial_par){
  ...
  init <- c(S_0, I_S0 , I_A0, R_S0, R_A0, W_0, S0, I0, R0)
...
#initial_value = c((1 - DATA[1]*0.0000116), DATA[1]*0.0000116, 0 , 0 , 0, 0 ,
...
lamda = 0
c <- 1
mea_vector_ASYMPsir_parallel <- c()
PARAMETERS_ASYMPsir_parallel <- c()
while (c < 500) {
  beta_IS <- rnorm(1, mean = 0.3, sd = 0.3*0.2)
  beta_IA <- rnorm(1, mean = 0.02, sd = 0.02*0.2)
  beta_W <- rnorm(1, mean = 3, sd = 3*0.01)
  ...
  mea_vector_ASYMPsir_parallel <- c(mea_vector_ASYMPsir_parallel,B$MSE)
  PARAMETERS_ASYMPsir_parallel <- rbind(PARAMETERS_ASYMPsir_parallel,B$parameters)
  c <- c+1
}
...
lamda = (1e+05)*5
c <- 1
mea_vector_1_ASYMPsir_parallel <- c()
PARAMETERS_1_ASYMPsir_parallel <- c()
while (c < 500) {
  beta_IS <- rnorm(1, mean = 0.3, sd = 0.3*0.2)
  beta_IA <- rnorm(1, mean = 0.02, sd = 0.02*0.2)
  beta_W <- rnorm(1, mean = 3, sd = 3*0.01)
  ...
  DATA_test <-  DATA[(end+1):n]
  B <- Blocking_CV_1(DATA_train , DATA_test, lamda,initial_value,initial_par)
  mea_vector_1_ASYMPsir_parallel <- c(mea_vector_1_ASYMPsir_parallel,B$MSE)
  PARAMETERS_1_ASYMPsir_parallel <- rbind(PARAMETERS_1_ASYMPsir_parallel,B$parameters)
  c <- c+1
}
...
lamda = (1e+05)*10
c <- 1
mea_vector_2_ASYMPsir_parallel <- c()
PARAMETERS_2_ASYMPsir_parallel <- c()
while (c < 500) {
  beta_IS <- rnorm(1, mean = 0.3, sd = 0.3*0.2)
  beta_IA <- rnorm(1, mean = 0.02, sd = 0.02*0.2)
  beta_W <- rnorm(1, mean = 3, sd = 3*0.01)
  ...
  DATA_test <-  DATA[(end+1):n]
  B <- Blocking_CV_1(DATA_train , DATA_test, lamda,initial_value,initial_par)
  mea_vector_2_ASYMPsir_parallel <- c(mea_vector_2_ASYMPsir_parallel,B$MSE)
  PARAMETERS_2_ASYMPsir_parallel <- rbind(PARAMETERS_2_ASYMPsir_parallel,B$parameters)
  c <- c+1
}
...
lamda = (1e+05)*15
c <- 1
mea_vector_3_ASYMPsir_parallel <- c()
PARAMETERS_3_ASYMPsir_parallel <- c()
while (c < 500) {
  beta_IS <- rnorm(1, mean = 0.3, sd = 0.3*0.2)
  beta_IA <- rnorm(1, mean = 0.02, sd = 0.02*0.2)
  beta_W <- rnorm(1, mean = 3, sd = 3*0.01)
  ...
  DATA_test <-  DATA[(end+1):n]
  B <- Blocking_CV_1(DATA_train , DATA_test, lamda,initial_value,initial_par)
  mea_vector_3_ASYMPsir_parallel <- c(mea_vector_3_ASYMPsir_parallel,B$MSE)
  PARAMETERS_3_ASYMPsir_parallel <- rbind(PARAMETERS_3_ASYMPsir_parallel,B$parameters)
  c <- c+1
}
...
lamda = (1e+05)*20
c <- 1
mea_vector_4_ASYMPsir_parallel <- c()
PARAMETERS_4_ASYMPsir_parallel <- c()
while (c < 500) {
  beta_IS <- rnorm(1, mean = 0.3, sd = 0.3*0.2)
  beta_IA <- rnorm(1, mean = 0.02, sd = 0.02*0.2)
  beta_W <- rnorm(1, mean = 3, sd = 3*0.01)
  ...
  DATA_test <-  DATA[(end+1):n]
  B <- Blocking_CV_1(DATA_train , DATA_test, lamda,initial_value,initial_par)
  mea_vector_4_ASYMPsir_parallel <- c(mea_vector_4_ASYMPsir_parallel,B$MSE)
  PARAMETERS_4_ASYMPsir_parallel <- rbind(PARAMETERS_4_ASYMPsir_parallel,B$parameters)
  c <- c+1
}
...
lamda = (1e+05)*25
c <- 1
mea_vector_5_ASYMPsir_parallel <- c()
PARAMETERS_5_ASYMPsir_parallel <- c()
while (c < 500) {
  beta_IS <- rnorm(1, mean = 0.3, sd = 0.3*0.2)
  beta_IA <- rnorm(1, mean = 0.02, sd = 0.02*0.2)
  beta_W <- rnorm(1, mean = 3, sd = 3*0.01)
  ...
  DATA_test <-  DATA[(end+1):n]
  B <- Blocking_CV_1(DATA_train , DATA_test, lamda,initial_value,initial_par)
  mea_vector_5_ASYMPsir_parallel <- c(mea_vector_5_ASYMPsir_parallel,B$MSE)
  PARAMETERS_5_ASYMPsir_parallel <- rbind(PARAMETERS_5_ASYMPsir_parallel,B$parameters)
  c <- c+1
}
...
vector1 <- mea_vector_ASYMPsir_parallel
vector2 <- mea_vector_1_ASYMPsir_parallel
vector3 <- mea_vector_2_ASYMPsir_parallel
vector4 <- mea_vector_3_ASYMPsir_parallel
vector5 <- mea_vector_4_ASYMPsir_parallel
vector6 <- mea_vector_5_ASYMPsir_parallel
...
df1 <- as.data.frame(PARAMETERS_2_ASYMPsir_parallel)
df1 <- df1[, c("beta_IS", "beta_IA","beta_W","alpha_S","alpha_A","b","g")]
df_long <- melt(df1, variable.name = "Variable", value.name = "Value")
df_long$ColorGroup <- ifelse(df_long$Variable %in% c("beta_IS", "beta_IA","beta_W","alpha_S","alpha_A"), "Asymptomatic model","SIR model")
# Plot using ggplot2
ggplot(df_long, aes(x = Variable, y = Value, fill = ColorGroup)) +
  geom_boxplot() +
  scale_fill_manual(values = c("Asymptomatic model" = "blue", "SIR model"= "green")) +
  ylim(-0.1, 3.5)+
...
for (i in 1:dim(PARAMETERS_2_ASYMPsir_parallel)[1]){
  
  parameters <- PARAMETERS_2_ASYMPsir_parallel[i,]
  
  DATA_simulated <- Data_Generate(parameters, init, times)
  DATA_simulated <- min(1,parameters['wei'])*DATA_simulated[,3]/parameters['kinv_0']+(1- min(1,parameters['wei']))*(DATA_simulated[,9]/parameters['kinv'])
